<?php
/**
 * Sanitized cross-block style engine for Cresco Inspector values.
 *
...
final class StyleEngine {
	...
	public function register_attributes( $args, $block_name ) {
		...
		if ( ! isset( $args['attributes'][ self::ATTRIBUTE ] ) ) {
			$args['attributes'][ self::ATTRIBUTE ] = array( 'type' => 'object', 'default' => array() );
		}
		if ( ! isset( $args['attributes'][ self::VERSION_ATTRIBUTE ] ) ) {
			$args['attributes'][ self::VERSION_ATTRIBUTE ] = array( 'type' => 'number', 'default' => self::SCHEMA_VERSION );
		}
		return $args;
	}
	...
	public function render_block( $block_content, $block ) {
		...
		if ( ! $declarations || ! class_exists( '\\WP_HTML_Tag_Processor' ) ) {
			return $block_content;
		}
